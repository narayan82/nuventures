<?php
/**
 * Homepage introductory hero copy.
 *
 * @package NuVentures
 */
?>

<section class="hero-intro" data-hero-intro aria-label="<?php esc_attr_e('Introduction', 'nuventures'); ?>">
    <h1 class="hero-intro__copy" aria-live="polite" aria-atomic="true">
        We back
